...
module.exports = app => {
     ...
     */
    app.get("/subcategoriasfc", (req, res) => {
        SubcategoriasFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
    ...
    app.get("/subcategoriasfc/:id", (req, res) => {
        SubcategoriasFC.findOne({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/subcategoriasfc/:id", (req, res) => {
        SubcategoriasFC.destroy({
            where: {
                id: req.params.id
            }
        })
    ...
    app.post("/subcategoriasfc", (req, res) => {
        console.log(req.body)
        SubcategoriasFC.create(req.body.subcategoria)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/subcategoriasfc", (req, res) => {
        console.log(req.body)
        SubcategoriasFC.update(req.body.subcategoria, {
            where: {
                id: req.body.subcategoria.identificacion
            }})
            .then(result => {
                console.log(result)
                res.json(result)
