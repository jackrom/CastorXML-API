module.exports = app => {
     ...
     */
    app.get("/gastosdeventasantIfluc", (req, res) => {
        GastosdeventasAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosdeventasantIfluc/:id", (req, res) => {
        GastosdeventasAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosdeventasantIfluc/:id", (req, res) => {
        GastosdeventasAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosdeventasantIfluc", (req, res) => {
        ...
        GastosdeventasAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosdeventasAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosdeventasAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosdeventasantIfluc", (req, res) => {
        GastosdeventasAntIfluc.update(req.body.cuentas, {
            where: {
