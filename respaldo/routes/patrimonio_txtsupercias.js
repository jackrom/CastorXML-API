module.exports = app => {
     ...
     */
    app.get("/patrimoniotxt", (req, res) => {
        PatrimonioTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/patrimoniotxt/:id", (req, res) => {
        PatrimonioTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/patrimoniotxt/:id", (req, res) => {
        PatrimonioTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/patrimoniotxt", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/patrimoniotxt", (req, res) => {
        PatrimonioTxt.update(req.body.cuentas, {
            where: {
