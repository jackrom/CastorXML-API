module.exports = app => {
     ...
     */
    app.get("/perdidasacumvalnetrealizyotrasperdeninvantifluc", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/perdidasacumvalnetrealizyotrasperdeninvantifluc/:id", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/perdidasacumvalnetrealizyotrasperdeninvantifluc/:id", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/perdidasacumvalnetrealizyotrasperdeninvantifluc", (req, res) => {
        ...
        PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/perdidasacumvalnetrealizyotrasperdeninvantifluc", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvAntIfluc.update(req.body.cuentas, {
            where: {
