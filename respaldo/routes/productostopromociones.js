module.exports = app => {
     ...
     */
    app.get("/productostopromocionesfc", (req, res) => {
        ProductosToPromocionesfc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/productostopromocionesfc/:id", (req, res) => {
        ProductosToPromocionesfc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/productostopromocionesfc/:id", (req, res) => {
        ProductosToPromocionesfc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/productostopromocionesfc", (req, res) => {
        // console.log(req.body)
        ProductosToPromocionesfc.create(req.body)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/productostopromocionesfc", (req, res) => {
        let datos = {
        ...
        ProductosToPromocionesfc.update(datos, {
            where: {
                id: req.body.obj.id
            }
        })
