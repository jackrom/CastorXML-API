module.exports = app => {
     ...
     */
    app.get("/actividadesdeinversiontxt", (req, res) => {
        ActividadesdeinversionTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeinversiontxt/:id", (req, res) => {
        ActividadesdeinversionTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeinversiontxt/:id", (req, res) => {
        ActividadesdeinversionTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeinversiontxt", (req, res) => {
        ...
        ActividadesdeinversionTxt.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeinversionTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeinversionTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeinversiontxt", (req, res) => {
        ActividadesdeinversionTxt.update(req.body.cuentas, {
            where: {
