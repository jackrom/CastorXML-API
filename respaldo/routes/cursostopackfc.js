module.exports = app => {
     ...
     */
    app.get("/cursostopackfc", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/cursostopackfc/check/:pack/:curso", (req, res) => {
        CursostopackFC.findAll({
            where: {
               packId: req.params.pack,
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/cursostopackfc/:id", (req, res) => {
        CursostopackFC.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/cursostopackfc/:id", (req, res) => {
        CursostopackFC.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursostopackfc", (req, res) => {
        console.log(req.body)
        CursostopackFC.create(req.body)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/cursostopackfc/additem/:pack/:curso", (req, res) => {
        let data = {
            cursoId: req.params.curso,
            packId: req.params.pack
        }
        console.log(data)
        CursostopackFC.create(data)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/cursostopackfc", (req, res) => {
        let datos = {
