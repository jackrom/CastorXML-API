module.exports = app => {
     ...
     */
    app.get("/actividadesdeoperacionanttxt", (req, res) => {
        ActividadesdeoperacionAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeoperacionanttxt/:id", (req, res) => {
        ActividadesdeoperacionAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeoperacionanttxt/:id", (req, res) => {
        ActividadesdeoperacionAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeoperacionanttxt", (req, res) => {
        ...
        ActividadesdeoperacionAntTxt.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeoperacionAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeoperacionAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeoperacionanttxt", (req, res) => {
        ActividadesdeoperacionAntTxt.update(req.body.cuentas, {
            where: {
