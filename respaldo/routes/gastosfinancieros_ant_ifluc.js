module.exports = app => {
     ...
     */
    app.get("/gastosfinancierosantIfluc", (req, res) => {
        GastosfinancierosAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosfinancierosantIfluc/:id", (req, res) => {
        GastosfinancierosAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosfinancierosantIfluc/:id", (req, res) => {
        GastosfinancierosAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosfinancierosantIfluc", (req, res) => {
        ...
        GastosfinancierosAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosfinancierosAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosfinancierosAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosfinancierosantIfluc", (req, res) => {
        GastosfinancierosAntIfluc.update(req.body.cuentas, {
            where: {
