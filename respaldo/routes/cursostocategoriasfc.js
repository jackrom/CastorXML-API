module.exports = app => {
     ...
     */
    app.get("/cursostocategoriasfc", (req, res) => {
        CursostocategoriasFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/cursostocategoriasfc/:id", (req, res) => {
        CursostocategoriasFC.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/cursostocategoriasfc/:id", (req, res) => {
        CursostocategoriasFC.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursostocategoriasfc", (req, res) => {
        // console.log(req.body)
        CursostocategoriasFC.create(req.body.cursotocat)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/cursostocategoriasfc", (req, res) => {
        let datos = {
        ...
        CursostocategoriasFC.update(datos, {
            where: {
                id: req.body.obj.id
            }
        })
