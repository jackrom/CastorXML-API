...
module.exports = app => {
     ...
     */
    app.get("/tokensdatafastfc", (req, res) => {
        Tokensdatafastfc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/tokensdatafastfc/:id", (req, res) => {
        Tokensdatafastfc.findOne({
                where: {
                    id: req.params.id
                }
            })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/tokensdatafastfc/:id", (req, res) => {
        Tokensdatafastfc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/tokensdatafastfc", (req, res) => {
        Tokensdatafastfc.create(req.body.token)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/tokensdatafastfc", (req, res) => {
        Tokensdatafastfc.update(req.query, {where: {id: req.query.id}})
            .then(result => {
                console.log(result)
                res.json(result)
                //res.sendStatus(204)
