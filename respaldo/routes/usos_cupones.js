...
module.exports = app => {
     ...
     */
    app.get("/usoscuponesfc", (req, res) => {
        Usoscuponesfc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/usoscuponesfc/:id", (req, res) => {
        Usoscuponesfc.findOne({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/usoscuponesfc/codigo/:codigo", (req, res) => {
        Usoscuponesfc.findOne({
            where: {
                cuponCodigo: req.params.codigo
            }
        })
            .then(result => {
                res.json(result)
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/usoscuponesfc/:id", (req, res) => {
        Usoscuponesfc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/usoscuponesfc", (req, res) => {
        Usoscuponesfc.create(req.body.cupon)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/usoscuponesfc", (req, res) => {
        console.log(req.body.cupon)
        Usoscuponesfc.update(req.body.cupon, {
            where: {
