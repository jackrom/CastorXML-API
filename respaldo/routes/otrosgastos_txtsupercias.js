module.exports = app => {
     ...
     */
    app.get("/otrosgastostxt", (req, res) => {
        OtrosgastosTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosgastostxt/:id", (req, res) => {
        OtrosgastosTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosgastostxt/:id", (req, res) => {
        OtrosgastosTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosgastostxt", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosgastostxt", (req, res) => {
        OtrosgastosTxt.update(req.body.cuentas, {
            where: {
