module.exports = app => {
     ...
     */
    app.get("/otrosresultadosintegralestxt", (req, res) => {
        OtrosresultadosintegralesTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosresultadosintegralestxt/:id", (req, res) => {
        OtrosresultadosintegralesTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosresultadosintegralestxt/:id", (req, res) => {
        OtrosresultadosintegralesTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosresultadosintegralestxt", (req, res) => {
        ...
        OtrosresultadosintegralesTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OtrosresultadosintegralesTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OtrosresultadosintegralesTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosresultadosintegralestxt", (req, res) => {
        OtrosresultadosintegralesTxt.update(req.body.cuentas, {
            where: {
