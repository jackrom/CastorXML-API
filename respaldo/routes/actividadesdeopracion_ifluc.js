module.exports = app => {
     ...
     */
    app.get("/actividadesdeoperacionIfluc", (req, res) => {
        ActividadesdeoperacionIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeoperacionIfluc/:id", (req, res) => {
        ActividadesdeoperacionIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeoperacionIfluc/:id", (req, res) => {
        ActividadesdeoperacionIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeoperacionIfluc", (req, res) => {
        ...
        ActividadesdeoperacionIfluc.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeoperacionIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeoperacionIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeoperacionIfluc", (req, res) => {
        ActividadesdeoperacionIfluc.update(req.body.cuentas, {
            where: {
