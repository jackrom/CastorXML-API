module.exports = app => {
     ...
     */
    app.get("/actividadesdefinanciamientoantIfluc", (req, res) => {
        ActividadesdefinanciamientoAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdefinanciamientoantIfluc/:id", (req, res) => {
        ActividadesdefinanciamientoAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdefinanciamientoantIfluc/:id", (req, res) => {
        ActividadesdefinanciamientoAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdefinanciamientoantIfluc", (req, res) => {
        ...
        ActividadesdefinanciamientoAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActividadesdefinanciamientoAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdefinanciamientoAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdefinanciamientoantIfluc", (req, res) => {
        ActividadesdefinanciamientoAntIfluc.update(req.body.cuentas, {
            where: {
