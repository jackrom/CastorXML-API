module.exports = app => {
     ...
     */
    app.get("/activosnocorrientesanttxt", (req, res) => {
        ActivosnocorrientesAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/activosnocorrientesanttxt/:id", (req, res) => {
        ActivosnocorrientesAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/activosnocorrientesanttxt/:id", (req, res) => {
        ActivosnocorrientesAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/activosnocorrientesanttxt", (req, res) => {
        ...
        ActivosnocorrientesAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActivosnocorrientesAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActivosnocorrientesAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/activosnocorrientesanttxt", (req, res) => {
        ActivosnocorrientesAntTxt.update(req.body.cuentas, {
            where: {
