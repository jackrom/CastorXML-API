module.exports = app => {
     ...
     */
    app.get("/cursosmodulosonlinefc", (req, res) => {
        CursosmodulosonlineFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
    ...
    app.get("/cursosmodulosonlinefc/:id", (req, res) => {
        CursosmodulosonlineFC.findOne({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/cursosmodulosonlinefc/:id", (req, res) => {
        CursosmodulosonlineFC.destroy({
            where: {
                id: req.params.id
            }
        })
    ...
    app.post("/cursosmodulosonlinefc", (req, res) => {
        console.log(req.body)
        CursosmodulosonlineFC.create(req.body.newproducto)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/cursosmodulosonlinefc", (req, res) => {
        console.log(req.body)
        CursosmodulosonlineFC.update(req.body.newproducto, {
            where: {
