module.exports = app => {
     ...
     */
    app.get("/gastosadministrativosanttxt", (req, res) => {
        GastosadministrativosAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosadministrativosanttxt/:id", (req, res) => {
        GastosadministrativosAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosadministrativosanttxt/:id", (req, res) => {
        GastosadministrativosAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosadministrativosanttxt", (req, res) => {
        ...
        GastosadministrativosAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosadministrativosAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosadministrativosAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosadministrativosanttxt", (req, res) => {
        GastosadministrativosAntTxt.update(req.body.cuentas, {
            where: {
