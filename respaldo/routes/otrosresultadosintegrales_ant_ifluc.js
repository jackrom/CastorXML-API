module.exports = app => {
     ...
     */
    app.get("/otrosresultadosintegralesantIfluc", (req, res) => {
        OtrosresultadosintegralesAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosresultadosintegralesantIfluc/:id", (req, res) => {
        OtrosresultadosintegralesAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosresultadosintegralesantIfluc/:id", (req, res) => {
        OtrosresultadosintegralesAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosresultadosintegralesantIfluc", (req, res) => {
        ...
        OtrosresultadosintegralesAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OtrosresultadosintegralesAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OtrosresultadosintegralesAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosresultadosintegralesantIfluc", (req, res) => {
        OtrosresultadosintegralesAntIfluc.update(req.body.cuentas, {
            where: {
