module.exports = app => {
     ...
     */
    app.get("/actividadesdeoperaciontxt", (req, res) => {
        ActividadesdeoperacionTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeoperaciontxt/:id", (req, res) => {
        ActividadesdeoperacionTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeoperaciontxt/:id", (req, res) => {
        ActividadesdeoperacionTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeoperaciontxt", (req, res) => {
        ...
        ActividadesdeoperacionTxt.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeoperacionTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeoperacionTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeoperaciontxt", (req, res) => {
        ActividadesdeoperacionTxt.update(req.body.cuentas, {
            where: {
