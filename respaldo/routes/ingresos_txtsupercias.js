module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/ingresostxt/:id", (req, res) => {
        IngresosTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/ingresostxt/:id", (req, res) => {
        IngresosTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/ingresostxt", (req, res) => {
        IngresosTxt.update(req.body.cuentas, {
            where: {
