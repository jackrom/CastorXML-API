module.exports = app => {
     ...
     */
    app.get("/perdidasacumcuentasincobydeterioroifluc", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/perdidasacumcuentasincobydeterioroifluc/:id", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/perdidasacumcuentasincobydeterioroifluc/:id", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/perdidasacumcuentasincobydeterioroifluc", (req, res) => {
        ...
        PerdidasAcumCuentasIncobyDeterioroIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PerdidasAcumCuentasIncobyDeterioroIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PerdidasAcumCuentasIncobyDeterioroIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/perdidasacumcuentasincobydeterioroifluc", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroIfluc.update(req.body.cuentas, {
            where: {
