module.exports = app => {
     ...
     */
    app.get("/ingresosIfluc", (req, res) => {
        IngresosIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/ingresosIfluc/:id", (req, res) => {
        IngresosIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/ingresosIfluc/:id", (req, res) => {
        IngresosIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/ingresosIfluc", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/ingresosIfluc", (req, res) => {
        IngresosIfluc.update(req.body.cuentas, {
            where: {
