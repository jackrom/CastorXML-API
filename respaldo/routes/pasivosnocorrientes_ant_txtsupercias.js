module.exports = app => {
     ...
     */
    app.get("/pasivosnocorrientesanttxt", (req, res) => {
        PasivosnocorrientesAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/pasivosnocorrientesanttxt/:id", (req, res) => {
        PasivosnocorrientesAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/pasivosnocorrientesanttxt/:id", (req, res) => {
        PasivosnocorrientesAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/pasivosnocorrientesanttxt", (req, res) => {
        ...
        PasivosnocorrientesAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PasivosnocorrientesAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PasivosnocorrientesAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/pasivosnocorrientesanttxt", (req, res) => {
        PasivosnocorrientesAntTxt.update(req.body.cuentas, {
            where: {
