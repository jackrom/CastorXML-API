module.exports = app => {
     ...
     */
    app.get("/pasivosnocorrientesIfluc", (req, res) => {
        PasivosnocorrientesIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/pasivosnocorrientesIfluc/:id", (req, res) => {
        PasivosnocorrientesIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/pasivosnocorrientesIfluc/:id", (req, res) => {
        PasivosnocorrientesIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/pasivosnocorrientesIfluc", (req, res) => {
        ...
        PasivosnocorrientesIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PasivosnocorrientesIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PasivosnocorrientesIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/pasivosnocorrientesIfluc", (req, res) => {
        PasivosnocorrientesIfluc.update(req.body.cuentas, {
            where: {
