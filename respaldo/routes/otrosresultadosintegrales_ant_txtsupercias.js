module.exports = app => {
     ...
     */
    app.get("/otrosresultadosintegralesanttxt", (req, res) => {
        OtrosresultadosintegralesAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosresultadosintegralesanttxt/:id", (req, res) => {
        OtrosresultadosintegralesAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosresultadosintegralesanttxt/:id", (req, res) => {
        OtrosresultadosintegralesAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosresultadosintegralesanttxt", (req, res) => {
        ...
        OtrosresultadosintegralesAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OtrosresultadosintegralesAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OtrosresultadosintegralesAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosresultadosintegralesanttxt", (req, res) => {
        OtrosresultadosintegralesAntTxt.update(req.body.cuentas, {
            where: {
