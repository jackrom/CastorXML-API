module.exports = app => {
     ...
     */
    app.get("/operacionesdiscontinuadasanttxt", (req, res) => {
        OperacionesdiscontinuadasAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/operacionesdiscontinuadasanttxt/:id", (req, res) => {
        OperacionesdiscontinuadasAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/operacionesdiscontinuadasanttxt/:id", (req, res) => {
        OperacionesdiscontinuadasAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/operacionesdiscontinuadasanttxt", (req, res) => {
        ...
        OperacionesdiscontinuadasAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OperacionesdiscontinuadasAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OperacionesdiscontinuadasAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/operacionesdiscontinuadasanttxt", (req, res) => {
        OperacionesdiscontinuadasAntTxt.update(req.body.cuentas, {
            where: {
