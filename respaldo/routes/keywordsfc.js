...
module.exports = app => {
    const KeywordsFC = app.db.models.Keywordsfc
    const multer  = require('multer')
    const path = require('path')
    const fs = require('fs')
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/keywordsfc/:id", (req, res) => {
        KeywordsFC.destroy({
            where: {
                id: req.params.id
            }
    ...
    app.post("/keywordsfc", (req, res) => {
        console.log(req.body)
        KeywordsFC.create(req.body.subcategoria)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/keywordsfc", (req, res) => {
        console.log(req.body)
        KeywordsFC.update(req.body.subcategoria, {
            where: {
