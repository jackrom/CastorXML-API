module.exports = app => {
     ...
     */
    app.get("/actividadesdefinanciamientoanttxt", (req, res) => {
        ActividadesdefinanciamientoAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdefinanciamientoanttxt/:id", (req, res) => {
        ActividadesdefinanciamientoAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdefinanciamientoanttxt/:id", (req, res) => {
        ActividadesdefinanciamientoAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdefinanciamientoanttxt", (req, res) => {
        ...
        ActividadesdefinanciamientoAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActividadesdefinanciamientoAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdefinanciamientoAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdefinanciamientoanttxt", (req, res) => {
        ActividadesdefinanciamientoAntTxt.update(req.body.cuentas, {
            where: {
