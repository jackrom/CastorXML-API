module.exports = app => {
     ...
     */
    app.get("/actividadesdefinanciamientoIfluc", (req, res) => {
        ActividadesdefinanciamientoIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdefinanciamientoIfluc/:id", (req, res) => {
        ActividadesdefinanciamientoIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdefinanciamientoIfluc/:id", (req, res) => {
        ActividadesdefinanciamientoIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdefinanciamientoIfluc", (req, res) => {
        ...
        ActividadesdefinanciamientoIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActividadesdefinanciamientoIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdefinanciamientoIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdefinanciamientoIfluc", (req, res) => {
        ActividadesdefinanciamientoIfluc.update(req.body.cuentas, {
            where: {
