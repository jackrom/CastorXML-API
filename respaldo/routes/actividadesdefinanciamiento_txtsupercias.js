module.exports = app => {
     ...
     */
    app.get("/actividadesdefinanciamientotxt", (req, res) => {
        ActividadesdefinanciamientoTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdefinanciamientotxt/:id", (req, res) => {
        ActividadesdefinanciamientoTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdefinanciamientotxt/:id", (req, res) => {
        ActividadesdefinanciamientoTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdefinanciamientotxt", (req, res) => {
        ...
        ActividadesdefinanciamientoTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActividadesdefinanciamientoTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdefinanciamientoTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdefinanciamientotxt", (req, res) => {
        ActividadesdefinanciamientoTxt.update(req.body.cuentas, {
            where: {
