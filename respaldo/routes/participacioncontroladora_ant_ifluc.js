module.exports = app => {
     ...
     */
    app.get("/participacioncontroladoraantIfluc", (req, res) => {
        ParticipacioncontroladoraAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/participacioncontroladoraantIfluc/:id", (req, res) => {
        ParticipacioncontroladoraAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/participacioncontroladoraantIfluc/:id", (req, res) => {
        ParticipacioncontroladoraAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/participacioncontroladoraantIfluc", (req, res) => {
        ...
        ParticipacioncontroladoraAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ParticipacioncontroladoraAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ParticipacioncontroladoraAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/participacioncontroladoraantIfluc", (req, res) => {
        ParticipacioncontroladoraAntIfluc.update(req.body.cuentas, {
            where: {
