module.exports = app => {
     ...
     */
    app.get("/otrosantifluc", (req, res) => {
        OtrosAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosantifluc/:id", (req, res) => {
        OtrosAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosantifluc/:id", (req, res) => {
        OtrosAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosantifluc", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosantifluc", (req, res) => {
        OtrosAntIfluc.update(req.body.cuentas, {
            where: {
