module.exports = app => {
     ...
     */
    app.get("/impuestosdiferidosantifluc", (req, res) => {
        ImpuestosDiferidosAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/impuestosdiferidosantifluc/:id", (req, res) => {
        ImpuestosDiferidosAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/impuestosdiferidosantifluc/:id", (req, res) => {
        ImpuestosDiferidosAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/impuestosdiferidosantifluc", (req, res) => {
        ...
        ImpuestosDiferidosAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ImpuestosDiferidosAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ImpuestosDiferidosAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/impuestosdiferidosantifluc", (req, res) => {
        ImpuestosDiferidosAntIfluc.update(req.body.cuentas, {
            where: {
