module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/costostxt/:id", (req, res) => {
        CostosTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/costostxt/:id", (req, res) => {
        CostosTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/costostxt", (req, res) => {
        CostosTxt.update(req.body.cuentas, {
            where: {
