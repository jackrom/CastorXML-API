module.exports = app => {
    ...
    app.get("/leccionesfc/:id", (req, res) => {
        LeccionesFC.findOne({
            where: {
                id: req.params.id
            }
    ...
    app.post("/leccionesfc/byuser", (req, res) => {
        LeccionesFC.findAll({
            where: {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/leccionesfc/:id", (req, res) => {
        LeccionesFC.destroy({
            where: {
                id: req.params.id
            }
    ...
    app.post("/leccionesfc", (req, res) => {
        // console.log(req.body.leccion)
        LeccionesFC.create(req.body.leccion)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/leccionesfc", (req, res) => {
        // console.log(req.body.leccion)
        LeccionesFC.update(req.body.leccion, {
            where: {
