module.exports = app => {
     ...
     */
    app.get("/actividadesdeinversionanttxt", (req, res) => {
        ActividadesdeinversionAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeinversionanttxt/:id", (req, res) => {
        ActividadesdeinversionAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeinversionanttxt/:id", (req, res) => {
        ActividadesdeinversionAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeinversionanttxt", (req, res) => {
        ...
        ActividadesdeinversionAntTxt.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeinversionAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeinversionAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeinversionanttxt", (req, res) => {
        ActividadesdeinversionAntTxt.update(req.body.cuentas, {
            where: {
