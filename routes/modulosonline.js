...
module.exports = app => {
     ...
     */
    app.get("/modulosonlinefc", (req, res) => {
        ModulosonlineFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
    ...
    app.get("/modulosonlinefc/:id", (req, res) => {
        ModulosonlineFC.findOne({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/modulosonlinefc/:id", (req, res) => {
        ModulosonlineFC.destroy({
            where: {
                id: req.params.id
            }
        })
    ...
    app.post("/modulosonlinefc", (req, res) => {
        console.log(req.body)
        ModulosonlineFC.create(req.body.newproducto)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/modulosonlinefc", (req, res) => {
        console.log(req.body)
        ModulosonlineFC.update(req.body.newproducto, {
            where: {
