module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/costosIfluc/:id", (req, res) => {
        CostosIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/costosIfluc/:id", (req, res) => {
        CostosIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/costosIfluc", (req, res) => {
        CostosIfluc.update(req.body.cuentas, {
            where: {
