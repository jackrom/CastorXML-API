module.exports = app => {
     ...
     */
    app.get("/actividadesdeinversionIfluc", (req, res) => {
        ActividadesdeinversionIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeinversionIfluc/:id", (req, res) => {
        ActividadesdeinversionIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeinversionIfluc/:id", (req, res) => {
        ActividadesdeinversionIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeinversionIfluc", (req, res) => {
        ...
        ActividadesdeinversionIfluc.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeinversionIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeinversionIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeinversionIfluc", (req, res) => {
        ActividadesdeinversionIfluc.update(req.body.cuentas, {
            where: {
