module.exports = app => {
     ...
     */
    app.get("/actividadesdeoperacionantIfluc", (req, res) => {
        ActividadesdeoperacionAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeoperacionantIfluc/:id", (req, res) => {
        ActividadesdeoperacionAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeoperacionantIfluc/:id", (req, res) => {
        ActividadesdeoperacionAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeoperacionantIfluc", (req, res) => {
        ...
        ActividadesdeoperacionAntIfluc.findAll({
            ...
            .then(resultados => {
                ...
                if (resultados && resultados.length > 0) {
                    ActividadesdeoperacionAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeoperacionAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeoperacionantIfluc", (req, res) => {
        ActividadesdeoperacionAntIfluc.update(req.body.cuentas, {
            where: {
