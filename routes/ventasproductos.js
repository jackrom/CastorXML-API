...
module.exports = app => {
     ...
     */
    app.get("/ventasproducto", (req, res) => {
        Ventasproducto.findAll({
            include: [
                {
                    model: Users,
                    as: 'user',
    ...
    app.get("/ventasproducto/nuevas", (req, res) => {
        Ventasproducto.findAll({
            include: [
                {
                    model: Users,
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/ventasproductoByUser/:id", (req, res) => {
        Ventasproducto.findAll({
            where: {
    ...
    app.get("/ventasproducto/afiliados/:serial", (req, res) => {
        Ventasproducto.findAll({
            where: {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/ventasproducto/:id", (req, res) => {
        Ventasproducto.destroy({where: {id: req.params.id}})
            .then(result => {
                console.log(result)
                res.json(result)
            })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/ventasproducto", (req, res) => {
        console.log(req.body.venta)
        Ventasproducto.create(req.body.venta)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/ventasproducto", (req, res) => {
        Ventasproducto.update(req.body.venta, {
            where: {
