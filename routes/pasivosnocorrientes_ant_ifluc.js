module.exports = app => {
     ...
     */
    app.get("/pasivosnocorrientesantIfluc", (req, res) => {
        PasivosnocorrientesAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/pasivosnocorrientesantIfluc/:id", (req, res) => {
        PasivosnocorrientesAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/pasivosnocorrientesantIfluc/:id", (req, res) => {
        PasivosnocorrientesAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/pasivosnocorrientesantIfluc", (req, res) => {
        ...
        PasivosnocorrientesAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PasivosnocorrientesAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PasivosnocorrientesAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/pasivosnocorrientesantIfluc", (req, res) => {
        PasivosnocorrientesAntIfluc.update(req.body.cuentas, {
            where: {
