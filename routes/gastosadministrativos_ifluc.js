module.exports = app => {
     ...
     */
    app.get("/gastosadministrativosIfluc", (req, res) => {
        GastosadministrativosIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosadministrativosIfluc/:id", (req, res) => {
        GastosadministrativosIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosadministrativosIfluc/:id", (req, res) => {
        GastosadministrativosIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosadministrativosIfluc", (req, res) => {
        ...
        GastosadministrativosIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosadministrativosIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosadministrativosIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosadministrativosIfluc", (req, res) => {
        GastosadministrativosIfluc.update(req.body.cuentas, {
            where: {
