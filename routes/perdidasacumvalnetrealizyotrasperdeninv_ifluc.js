module.exports = app => {
     ...
     */
    app.get("/perdidasacumvalnetrealizyotrasperdeninvifluc", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/perdidasacumvalnetrealizyotrasperdeninvifluc/:id", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/perdidasacumvalnetrealizyotrasperdeninvifluc/:id", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/perdidasacumvalnetrealizyotrasperdeninvifluc", (req, res) => {
        ...
        PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/perdidasacumvalnetrealizyotrasperdeninvifluc", (req, res) => {
        PerdidasAcumValNetRealizyOtrasPerdEnInvIfluc.update(req.body.cuentas, {
            where: {
