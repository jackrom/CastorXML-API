module.exports = app => {
     ...
     */
    app.get("/operacionesdiscontinuadasIfluc", (req, res) => {
        OperacionesdiscontinuadasIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/operacionesdiscontinuadasIfluc/:id", (req, res) => {
        OperacionesdiscontinuadasIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/operacionesdiscontinuadasIfluc/:id", (req, res) => {
        OperacionesdiscontinuadasIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/operacionesdiscontinuadasIfluc", (req, res) => {
        ...
        OperacionesdiscontinuadasIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OperacionesdiscontinuadasIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OperacionesdiscontinuadasIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/operacionesdiscontinuadasIfluc", (req, res) => {
        OperacionesdiscontinuadasIfluc.update(req.body.cuentas, {
            where: {
