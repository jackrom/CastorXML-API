module.exports = app => {
     ...
     */
    app.get("/operacionesdiscontinuadastxt", (req, res) => {
        OperacionesdiscontinuadasTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/operacionesdiscontinuadastxt/:id", (req, res) => {
        OperacionesdiscontinuadasTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/operacionesdiscontinuadastxt/:id", (req, res) => {
        OperacionesdiscontinuadasTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/operacionesdiscontinuadastxt", (req, res) => {
        ...
        OperacionesdiscontinuadasTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OperacionesdiscontinuadasTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OperacionesdiscontinuadasTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/operacionesdiscontinuadastxt", (req, res) => {
        OperacionesdiscontinuadasTxt.update(req.body.cuentas, {
            where: {
