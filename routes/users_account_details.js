module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/usersaccountdetail/:id", (req, res) => {
        Usersaccountdetail.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/usersaccountdetail/:id", (req, res) => {
        Usersaccountdetail.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/usersaccountdetail", (req, res) => {
        Usersaccountdetail.create(req.body.usuario)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/usersaccountdetail", (req, res) => {
        console.log('user', req.body.user)
        Usersaccountdetail.update(req.body.user, {
            where: {
