...
module.exports = app => {
     ...
     */
    app.get("/leccionesvistasfc", (req, res) => {
        LeccionesvistasFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
    ...
    app.get("/leccionesvistasfc/:id", (req, res) => {
        LeccionesvistasFC.findOne({
            where: {
                id: req.params.id
            }
        })
    ...
    app.post("/leccionesvistasfc/byuser", (req, res) => {
        LeccionesvistasFC.findAll({
            where: {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/leccionesvistasfc/:id", (req, res) => {
        LeccionesvistasFC.destroy({
            where: {
                id: req.params.id
            }
        })
    ...
    app.post("/leccionesvistasfc", (req, res) => {
        // console.log(req.body.leccion)
        LeccionesvistasFC.create(req.body.leccion)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/leccionesvistasfc", (req, res) => {
        // console.log(req.body.leccion)
        LeccionesvistasFC.update(req.body.leccion, {
            where: {
