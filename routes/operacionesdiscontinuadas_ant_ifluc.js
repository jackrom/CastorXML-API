module.exports = app => {
     ...
     */
    app.get("/operacionesdiscontinuadasantIfluc", (req, res) => {
        OperacionesdiscontinuadasAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/operacionesdiscontinuadasantIfluc/:id", (req, res) => {
        OperacionesdiscontinuadasAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/operacionesdiscontinuadasantIfluc/:id", (req, res) => {
        OperacionesdiscontinuadasAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/operacionesdiscontinuadasantIfluc", (req, res) => {
        ...
        OperacionesdiscontinuadasAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OperacionesdiscontinuadasAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OperacionesdiscontinuadasAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/operacionesdiscontinuadasantIfluc", (req, res) => {
        OperacionesdiscontinuadasAntIfluc.update(req.body.cuentas, {
            where: {
