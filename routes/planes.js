module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/planesfc/:id", (req, res) => {
        PlanesFC.destroy({
            where: {
                id: req.params.id
            }
    ...
    app.post("/planesfc", (req, res) => {
        console.log(req.body)
        PlanesFC.create(req.body.producto)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/planesfc", (req, res) => {
        console.log(req.body)
        PlanesFC.update(req.body.producto, {
            where: {
