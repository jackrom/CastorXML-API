module.exports = app => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/periodosifluc/bycompany", (req, res) => {
        PeriodosIfluc.findAll({
            where: {
    ...
    app.get("/periodosifluc/byuser", (req, res) => {
        PeriodosIfluc.findAll({
            include: [
                {
                    model: EmpresasIfluc,
            ...
            .then(results => {
                ...
                res.json({ periodos: filteredPeriodos, totalPage, totalPeriodos})
            })
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/periodosifluc/:id", (req, res) => {
        PeriodosIfluc.findOne({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/periodosifluc/:id", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/periodosifluc", (req, res) => {
        PeriodosIfluc.create(req.body.periodo)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/periodosifluc", (req, res) => {
        PeriodosIfluc.update(req.query, {where: {id: req.query.id}})
            .then(result => {
                res.json(result)
            })
            .catch(error => {
