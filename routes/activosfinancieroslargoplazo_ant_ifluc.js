module.exports = app => {
     ...
     */
    app.get("/activosfinancieroslargoplazoantifluc", (req, res) => {
        ActivosFinancierosLargoPlazoAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/activosfinancieroslargoplazoantifluc/:id", (req, res) => {
        ActivosFinancierosLargoPlazoAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/activosfinancieroslargoplazoantifluc/:id", (req, res) => {
        ActivosFinancierosLargoPlazoAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/activosfinancieroslargoplazoantifluc", (req, res) => {
        ...
        ActivosFinancierosLargoPlazoAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActivosFinancierosLargoPlazoAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActivosFinancierosLargoPlazoAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/activosfinancieroslargoplazoantifluc", (req, res) => {
        ActivosFinancierosLargoPlazoAntIfluc.update(req.body.cuentas, {
            where: {
