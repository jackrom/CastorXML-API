...
module.exports = app => {
    const Logsdatafast = app.db.models.Logsdatafast
     ...
     */
    app.get("/logsdatafast", (req, res) => {
        Logsdatafast.findAll({
            attributes: [
                "amount",
                "customer",
                "fecha",
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/logsdatafast/:id", (req, res) => {
        Logsdatafast.findById(req.params.id)
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/logsdatafast/:id", (req, res) => {
        Logsdatafast.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/logsdatafast", (req, res) => {
        // console.log('TRANSACCION: ', req.body.transaccion)
        Logsdatafast.create(req.body.transaccion)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/logsdatafast", (req, res) => {
        Logsdatafast.update(req.body.transaccion, {
