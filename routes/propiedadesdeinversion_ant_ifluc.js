module.exports = app => {
     ...
     */
    app.get("/propiedadesdeinversionantifluc", (req, res) => {
        PropiedadesDeInversionAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/propiedadesdeinversionantifluc/:id", (req, res) => {
        PropiedadesDeInversionAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/propiedadesdeinversionantifluc/:id", (req, res) => {
        PropiedadesDeInversionAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/propiedadesdeinversionantifluc", (req, res) => {
        ...
        PropiedadesDeInversionAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PropiedadesDeInversionAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PropiedadesDeInversionAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/propiedadesdeinversionantifluc", (req, res) => {
        PropiedadesDeInversionAntIfluc.update(req.body.cuentas, {
            where: {
