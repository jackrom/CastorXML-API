module.exports = app => {
     ...
     */
    app.get("/cursospreciosfc", (req, res) => {
        CursospreciosFC.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursospreciosfc/preciosByAppAndOpcion", (req, res) => {
        console.log(req.body)
        CursospreciosFC.findOne({
            where: {
                productoId: req.body.solicitud.producto,
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursospreciosfc/preciosByAppAndOpcionWithPromo", (req, res) => {
        console.log(req.body)
        CursospreciosFC.findOne({
            where: {
                productoId: req.body.solicitud.producto,
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursospreciosfc/preciosByProducts", (req, res) => {
        console.log(req.body)
        CursospreciosFC.findAll()
            .then(result => {
                let productos = []
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursospreciosfc/preciosByModulo/:id", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/cursospreciosfc/:id", (req, res) => {
        CursospreciosFC.destroy({
            where: {
                id: req.params.id
            }
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/cursospreciosfc", (req, res) => {
        console.log(req.body)
        CursospreciosFC.create(req.body.producto)
            .then(result => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/cursospreciosfc", (req, res) => {
        console.log(req.body)
        CursospreciosFC.update(req.body.producto, {
            where: {
