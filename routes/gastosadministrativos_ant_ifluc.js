module.exports = app => {
     ...
     */
    app.get("/gastosadministrativosantIfluc", (req, res) => {
        GastosadministrativosAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosadministrativosantIfluc/:id", (req, res) => {
        GastosadministrativosAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosadministrativosantIfluc/:id", (req, res) => {
        GastosadministrativosAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosadministrativosantIfluc", (req, res) => {
        ...
        GastosadministrativosAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosadministrativosAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosadministrativosAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosadministrativosantIfluc", (req, res) => {
        GastosadministrativosAntIfluc.update(req.body.cuentas, {
            where: {
