module.exports = app => {
     ...
     */
    app.get("/gastosdeventasanttxt", (req, res) => {
        GastosdeventasAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/gastosdeventasanttxt/:id", (req, res) => {
        GastosdeventasAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/gastosdeventasanttxt/:id", (req, res) => {
        GastosdeventasAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/gastosdeventasanttxt", (req, res) => {
        ...
        GastosdeventasAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    GastosdeventasAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    GastosdeventasAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/gastosdeventasanttxt", (req, res) => {
        GastosdeventasAntTxt.update(req.body.cuentas, {
            where: {
