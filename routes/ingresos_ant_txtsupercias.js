module.exports = app => {
     ...
     */
    app.get("/ingresosanttxt", (req, res) => {
        IngresosAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/ingresosanttxt/:id", (req, res) => {
        IngresosAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/ingresosanttxt/:id", (req, res) => {
        IngresosAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/ingresosanttxt", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/ingresosanttxt", (req, res) => {
        IngresosAntTxt.update(req.body.cuentas, {
            where: {
