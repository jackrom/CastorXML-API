module.exports = app => {
     ...
     */
    app.get("/participacioncontroladoraanttxt", (req, res) => {
        ParticipacioncontroladoraAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/participacioncontroladoraanttxt/:id", (req, res) => {
        ParticipacioncontroladoraAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/participacioncontroladoraanttxt/:id", (req, res) => {
        ParticipacioncontroladoraAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/participacioncontroladoraanttxt", (req, res) => {
        ...
        ParticipacioncontroladoraAntTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ParticipacioncontroladoraAntTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ParticipacioncontroladoraAntTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/participacioncontroladoraanttxt", (req, res) => {
        ParticipacioncontroladoraAntTxt.update(req.body.cuentas, {
            where: {
