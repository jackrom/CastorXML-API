module.exports = app => {
     ...
     */
    app.get("/propiedadesplantasyequiposantifluc", (req, res) => {
        PropiedadesPlantasyEquiposAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/propiedadesplantasyequiposantifluc/:id", (req, res) => {
        PropiedadesPlantasyEquiposAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/propiedadesplantasyequiposantifluc/:id", (req, res) => {
        PropiedadesPlantasyEquiposAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/propiedadesplantasyequiposantifluc", (req, res) => {
        ...
        PropiedadesPlantasyEquiposAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PropiedadesPlantasyEquiposAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PropiedadesPlantasyEquiposAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/propiedadesplantasyequiposantifluc", (req, res) => {
        PropiedadesPlantasyEquiposAntIfluc.update(req.body.cuentas, {
            where: {
