module.exports = app => {
     ...
     */
    app.get("/participacioncontroladoraIfluc", (req, res) => {
        ParticipacioncontroladoraIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/participacioncontroladoraIfluc/:id", (req, res) => {
        ParticipacioncontroladoraIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/participacioncontroladoraIfluc/:id", (req, res) => {
        ParticipacioncontroladoraIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/participacioncontroladoraIfluc", (req, res) => {
        ...
        ParticipacioncontroladoraIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ParticipacioncontroladoraIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ParticipacioncontroladoraIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/participacioncontroladoraIfluc", (req, res) => {
        ParticipacioncontroladoraIfluc.update(req.body.cuentas, {
            where: {
