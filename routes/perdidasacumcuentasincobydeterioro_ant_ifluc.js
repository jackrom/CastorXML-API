module.exports = app => {
     ...
     */
    app.get("/perdidasacumcuentasincobydeterioroantifluc", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/perdidasacumcuentasincobydeterioroantifluc/:id", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/perdidasacumcuentasincobydeterioroantifluc/:id", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/perdidasacumcuentasincobydeterioroantifluc", (req, res) => {
        ...
        PerdidasAcumCuentasIncobyDeterioroAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PerdidasAcumCuentasIncobyDeterioroAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PerdidasAcumCuentasIncobyDeterioroAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/perdidasacumcuentasincobydeterioroantifluc", (req, res) => {
        PerdidasAcumCuentasIncobyDeterioroAntIfluc.update(req.body.cuentas, {
            where: {
