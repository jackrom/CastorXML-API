module.exports = app => {
     ...
     */
    app.get("/pasivoscorrientesantIfluc", (req, res) => {
        PasivoscorrientesAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/pasivoscorrientesantIfluc/:id", (req, res) => {
        PasivoscorrientesAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/pasivoscorrientesantIfluc/:id", (req, res) => {
        PasivoscorrientesAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/pasivoscorrientesantIfluc", (req, res) => {
        ...
        PasivoscorrientesAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    PasivoscorrientesAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    PasivoscorrientesAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/pasivoscorrientesantIfluc", (req, res) => {
        PasivoscorrientesAntIfluc.update(req.body.cuentas, {
            where: {
