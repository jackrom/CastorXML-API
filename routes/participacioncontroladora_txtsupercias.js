module.exports = app => {
     ...
     */
    app.get("/participacioncontroladoratxt", (req, res) => {
        ParticipacioncontroladoraTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/participacioncontroladoratxt/:id", (req, res) => {
        ParticipacioncontroladoraTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/participacioncontroladoratxt/:id", (req, res) => {
        ParticipacioncontroladoraTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/participacioncontroladoratxt", (req, res) => {
        ...
        ParticipacioncontroladoraTxt.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ParticipacioncontroladoraTxt.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ParticipacioncontroladoraTxt.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/participacioncontroladoratxt", (req, res) => {
        ParticipacioncontroladoraTxt.update(req.body.cuentas, {
            where: {
