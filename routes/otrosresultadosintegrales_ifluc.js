module.exports = app => {
     ...
     */
    app.get("/otrosresultadosintegralesIfluc", (req, res) => {
        OtrosresultadosintegralesIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/otrosresultadosintegralesIfluc/:id", (req, res) => {
        OtrosresultadosintegralesIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/otrosresultadosintegralesIfluc/:id", (req, res) => {
        OtrosresultadosintegralesIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/otrosresultadosintegralesIfluc", (req, res) => {
        ...
        OtrosresultadosintegralesIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    OtrosresultadosintegralesIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    OtrosresultadosintegralesIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/otrosresultadosintegralesIfluc", (req, res) => {
        OtrosresultadosintegralesIfluc.update(req.body.cuentas, {
            where: {
