module.exports = app => {
     ...
     */
    app.get("/actividadesdeinversionantIfluc", (req, res) => {
        ActividadesdeinversionAntIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/actividadesdeinversionantIfluc/:id", (req, res) => {
        ActividadesdeinversionAntIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/actividadesdeinversionantIfluc/:id", (req, res) => {
        ActividadesdeinversionAntIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/actividadesdeinversionantIfluc", (req, res) => {
        ...
        ActividadesdeinversionAntIfluc.findAll({
            ...
            .then(resultados => {
                if (resultados && resultados.length > 0) {
                    ActividadesdeinversionAntIfluc.update(reporte, {
                        where: {
                            id: resultados[0].id
                        }
                    })
                    ...
                    ActividadesdeinversionAntIfluc.create(reporte)
                        .then(result => {
                            res.json(result)
                        })
                        .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/actividadesdeinversionantIfluc", (req, res) => {
        ActividadesdeinversionAntIfluc.update(req.body.cuentas, {
            where: {
