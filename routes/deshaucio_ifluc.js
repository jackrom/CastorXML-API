module.exports = app => {
     ...
     */
    app.get("/deshaucioifluc", (req, res) => {
        DeshaucioIfluc.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/deshaucioifluc/:id", (req, res) => {
        DeshaucioIfluc.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/deshaucioifluc/:id", (req, res) => {
        DeshaucioIfluc.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.post("/deshaucioifluc", (req, res) => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/deshaucioifluc", (req, res) => {
        DeshaucioIfluc.update(req.body.cuentas, {
            where: {
