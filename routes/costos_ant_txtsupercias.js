module.exports = app => {
     ...
     */
    app.get("/costosanttxt", (req, res) => {
        CostosAntTxt.findAll({
            order: [
                ['id', 'DESC'],
            ]
        })
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.get("/costosanttxt/:id", (req, res) => {
        CostosAntTxt.findOne({where: {id: req.params.id}})
            .then(result => res.json(result))
            .catch(error => {
                res.status(412).json({msg: error.message});
            });
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.delete("/costosanttxt/:id", (req, res) => {
        CostosAntTxt.destroy({where: {id: req.params.id}})
            .then(res => {
                res.json(result)
            })
            .catch(error => {
     ...
     * HTTP/1.1 412 Precondition Failed
     */
    app.put("/costosanttxt", (req, res) => {
        CostosAntTxt.update(req.body.cuentas, {
            where: {
